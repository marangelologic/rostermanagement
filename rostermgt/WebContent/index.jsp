...
<link rel="shortcut icon" type="image/x-icon"
	...
	<link href="js/ios/css/iosOverlay.css" rel="stylesheet" type="text/css" />
	<link rel="stylesheet"
	...
	<script type="text/javascript">
		...
		$(document)['ready']
				...
				(function() {//0153903//mar
					...
					SetSecurity(localStorage
							.getItem("0b8b667e7722bc7e363b601ce584259d"));//0122467
		...
		function SetAccessLinks() {
			...
			} else if (localStorage.getItem("29a7e96467b69a9f5a93332e29e9b0de") == "d66636b253cb346dbb6240e30def3618") {
				$('#load_qm_reports').show();
				$("#qa_links").show();
				$('#content')['load']('view/vqmtmd');
				$("#load_qm_target").show();
				$("#qa_evaluators").show();
			} else if (localStorage.getItem("29a7e96467b69a9f5a93332e29e9b0de") == "b33aed8f3134996703dc39f9a7c95783") {
				...
				success : function(response) {
					...
					for (var i = 0; i < resultsArray.length; i++) {
						if (resultsArray[0].countReqs == 0) {
							...
							$("#qm_new_res").text(resultsArray[0].countReqs);
						}
					}
